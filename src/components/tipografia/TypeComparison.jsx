import letterSpacingGuide from "../../../assets/images/tipografia/Image-Letter-Spacing.png";
...
export default function TypeComparison() {
  return (
    <div className="type-comparison">
      ...
      <div className="type-comparison__col">
        {/* The export bakes the sample text and its guide lines together, so
            it stands in for the live text here — CSS-positioned lines could
            never track the real letterforms across font/layout shifts. */}
        <div className="type-sample-panel">
          <img
            className="type-sample-panel__guide"
            src={letterSpacingGuide}
            alt="Squad para deixar marca."
          />
        </div>
