...
// Marks a frame group "visible" the first time it enters the viewport —
// already in view at mount (initial load) fires almost immediately; below
// the fold waits for the user to actually scroll it into view. Fires once,
// then disconnects, so scrolling back past it doesn't replay the reveal.
